<div class="row">
    <div class="col-md-12">
        <div class="ibox ibox-danger">
            ...
            <div class="ibox-body">
                <table id="tabla_cliente" class="display responsive nowrap table" style="width:100%">
                    <thead>
                        <tr>
                            <th>#</th>
                            <th>Persona</th>
...
<form action="" id="registrar_cliente">
    <div class="modal fade" id="modal_registrar_cliente" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
