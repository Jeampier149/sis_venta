            ...
            <div class="ibox-body">
                <div class="row d-flex justify-content-around mt-4">
                    ...
                    <div class="col-5">
                        <div class="ibox ibox-info shad">
                            <div class="ibox-head titu">
                                <div class="ibox-title data">DETALLES DEL INGRESO</div>
                            </div>
                            <div class="ibox-body">
                                <div class="col-lg-12 mb-4">
                                    <label for="">Proveedor</label>
                                    <select class="js-example-basic-single" id="cbm_proveedor" class="form-control" style="width:100%;">
                                    </select>
                                </div>
                                <div class="col-lg-12 mb-4">
                    ...
                    <div class="ibox ibox-info">
                        ...
                        <div class="ibox-body shad">
                            ...
                            <div class="row d-flex justify-content-end mt-4 ocultar" id="reg">
                                <div class="col-3">
                                    <button class="btn boton-exito" style="width:100%" onclick="registrar_ingreso()">Registrar</button>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
    $(document).ready(function() {
        ...
        listar_combo_producto_ingreso()
        listar_combo_proveedor_ingreso()
